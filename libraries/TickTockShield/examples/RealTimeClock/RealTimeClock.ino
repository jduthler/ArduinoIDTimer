...
boolean flag_scan_again;//1 = can scan key again at the state of SYSTEM_NORMAL
...
uint8_t system_states;
	#define SYSTEM_NORMAL    0 //default status,and the system will turn to "normal" status 
...
void clockStart()
{
  if(system_states == SYSTEM_NORMAL)//if it is normal states?
  {
